    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="project-card">
                ...
                <p><strong>타겟:</strong> 50만+ 개발자 | <strong>개발 기간:</strong> 2주</p>
            </div>
        ...
        <section id="build-plan" class="plan-section">
            ...
            <p style="text-align: center; font-size: 1.1rem; color: #cbd5e1; margin-bottom: 2rem;">
                1순위 제품인 <strong>Dev Daily</strong> 뉴스레터를 2주 안에 출시하기 위한 순서와 담당자를 공개합니다.
            </p>
            <div class="plan-grid">
                <div class="plan-step">
                    <h3>Step 1 · Discovery</h3>
                    <p class="plan-milestone">문제 정의, 핵심 KPI, 3분 요약 포맷 확정 (Day 1-2)</p>
                    <p class="plan-owners">Owners · Alex (PM), Sam (Growth)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 2 · Experience Design</h3>
                    <p class="plan-milestone">이메일 템플릿, 다크/라이트 테마, 구독 플로우 와이어프레임 (Day 2-4)</p>
                    <p class="plan-owners">Owners · Maya (Design), Alex (PM)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 3 · Build & Automation</h3>
                    <p class="plan-milestone">스크래퍼 + 요약 파이프라인 + 발송 스케줄러 구현 (Day 4-9)</p>
                    <p class="plan-owners">Owners · Claude (Lead Dev), 라Codex (Execution), Chris (FE), Jordan (BE)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 4 · QA & Launch</h3>
                    <p class="plan-milestone">테스트/모니터링, 온보딩 페이지, Product Hunt·HN 런치 키트 (Day 9-12)</p>
                    <p class="plan-owners">Owners · 라Codex (QA), Sam (Growth), Chris (FE)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 5 · Growth Loops</h3>
                    <p class="plan-milestone">추천 프로그램, 공유 배지, 뉴스레터 내 CTA 실험 (Day 12-14)</p>
        ...
        <section id="build-report" class="report-section">
            ...
            <div class="report-grid">
                ...
                <div class="report-card">
                    <h3>Timeline</h3>
                    <p>Day 1-14 (2주). 3일 마다 점검, Day 12에 Product Hunt/HN 런칭.</p>
                </div>
                <div class="report-card">
                    <h3>Owners & stack</h3>
                    <ul>
