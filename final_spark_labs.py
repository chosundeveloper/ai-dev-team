...
<body>
    <div class="container">
        ...
        <!-- Viral Projects -->
        <section>
            <h2>🚀 우리가 만드는 바이럴 프로젝트</h2>

            <div class="project-card">
                <h3 class="project-title">🗞️ Dev Daily - 개발자 일일 뉴스레터</h3>
                <span class="viral-badge">🔥 바이럴 점수: 9/10</span>
                <p style="font-size: 1.1rem; margin: 1rem 0; color: #cbd5e1;">
                    AI가 매일 아침 GitHub 트렌딩, Hacker News, Reddit을 분석해서
                    개발자에게 꼭 필요한 뉴스만 3분 분량으로 큐레이션합니다.
                </p>
                <p><strong>타겟:</strong> 50만+ 개발자 | <strong>상태:</strong> 지금 즉시 출시</p>
            </div>

            <div class="project-card">
                <h3 class="project-title">💻 Code Vault - 코드 스니펫 마켓플레이스</h3>
                <span class="viral-badge">🔥 바이럴 점수: 10/10</span>
                <p style="font-size: 1.1rem; margin: 1rem 0; color: #cbd5e1;">
                    개발자들이 자주 쓰는 코드 스니펫을 저장하고 공유하는 플랫폼.
                    AI가 자동으로 태깅하고 검색을 도와드립니다.
                </p>
                <p><strong>타겟:</strong> 100만+ 개발자 | <strong>개발 기간:</strong> 3주</p>
            </div>

            <div class="project-card">
                <h3 class="project-title">🎯 AI Interview Coach - AI 면접 준비</h3>
                <span class="viral-badge">🔥 바이럴 점수: 10/10</span>
                <p style="font-size: 1.1rem; margin: 1rem 0; color: #cbd5e1;">
                    실제 기업 면접 데이터를 학습한 AI가 1:1 모의 면접을 진행하고
                    실시간 피드백을 제공합니다.
                </p>
                <p><strong>타겟:</strong> 200만+ 구직자 | <strong>개발 기간:</strong> 4주</p>
            </div>
        </section>
        ...
        <section id="build-plan" class="plan-section">
            ...
            <p style="text-align: center; font-size: 1.1rem; color: #cbd5e1; margin-bottom: 2rem;">
                1순위 제품인 <strong>Dev Daily</strong> 뉴스레터를 지금 바로 출시하면서 동시에 실행 중인 순서와 담당자입니다.
            </p>
            <div class="plan-grid">
                <div class="plan-step">
                    <h3>Step 1 · Discovery Sync</h3>
                    <p class="plan-milestone">런치 직전 30분 내 시장 시그널과 KPI 재확인</p>
                    <p class="plan-owners">Owners · Alex (PM), Sam (Growth)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 2 · Experience Finalize</h3>
                    <p class="plan-milestone">이메일 템플릿/다크·라이트 테마 QA, 구독 플로우 점검 (런치 1시간 전)</p>
                    <p class="plan-owners">Owners · Maya (Design), Alex (PM)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 3 · Automation Go-Live</h3>
                    <p class="plan-milestone">스크래퍼·요약 파이프라인·발송 스케줄러 즉시 배포 (런치 타임)</p>
                    <p class="plan-owners">Owners · Claude (Lead Dev), 라Codex (Execution), Chris (FE), Jordan (BE)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 4 · QA & Launch Blast</h3>
                    <p class="plan-milestone">실사용자 테스트, 온보딩 페이지 공개, Product Hunt·HN 즉시 게시</p>
                    <p class="plan-owners">Owners · 라Codex (QA), Sam (Growth), Chris (FE)</p>
                </div>
                <div class="plan-step">
                    <h3>Step 5 · Live Growth Loops</h3>
                    <p class="plan-milestone">런치 직후 추천 프로그램/공유 배지/CTA 실험 즉시 가동</p>
                    <p class="plan-owners">Owners · Sam (Growth), Alex (PM), Claude (Automation)</p>
                </div>
            </div>
        </section>
        ...
        <section id="build-report" class="report-section">
            ...
            <p style="text-align: center; font-size: 1.05rem; color: #cbd5e1;">
                현재 스프린트의 목표, 산출물, 책임자를 한 페이지로 정리한 실행 보고서입니다.
            </p>
            <div class="report-grid">
                <div class="report-card">
                    <h3>What we ship</h3>
                    <p>Dev Daily — GitHub·HN·Reddit 데이터를 매일 3분 요약으로 보내는 개발자 뉴스레터.</p>
                </div>
                <div class="report-card">
                    <h3>Why it matters</h3>
                    <ul>
                        <li>정보 과부하를 해결하고 공유 가능한 포맷</li>
                        <li>커뮤니티 채널(HN/Reddit)과 찰떡 바이럴 소재</li>
                    </ul>
                </div>
                <div class="report-card">
                    <h3>Timeline</h3>
                    <p>지금 즉시 런치 (오늘). 오전 Discovery → 점심 템플릿 마감 → 오후 자동화 배포 → 저녁 Product Hunt/HN 공개 → +24h 모니터링.</p>
                </div>
                <div class="report-card">
                    <h3>Owners & stack</h3>
                    <ul>
                        <li>Alex · Sam — 전략/성장</li>
                        <li>Maya — 템플릿 디자인</li>
                        <li>Claude + 라Codex — 파이프라인 & QA</li>
                        <li>Chris + Jordan — FE/BE & 자동화</li>
                    </ul>
                </div>
            </div>
        </section>
